...
const prefixer = $prefixer('http://www.linkedmodel.org/schema/vaem#');
...
const vaem = {
  /**
    * **[uses non-imported resource](http://www.linkedmodel.org/schema/vaem#usesNonImportedResource)** (property)
    * 
    * The property "vaem:usesNonImportedResource" is used to express dependencies on resources from graphs that are not imported
    */
    usesNonImportedResource: prefixer('usesNonImportedResource'),

    /**
    * **[with attribution to](http://www.linkedmodel.org/schema/vaem#withAttributionTo)** (property)
    * 
    ...
    */
    withAttributionTo: prefixer('withAttributionTo'),

    /**
    * **[definition](http://www.linkedmodel.org/schema/vaem#comment)** (property)
    * 
    ...
    */
    ...
    /**
    * **[isDefinedBy](http://www.linkedmodel.org/schema/vaem#isElaboratedIn)** (property)
    * 
    * An annotation used to reference a graph that elaborates (adds properties and axioms to) a resource
    */
    isElaboratedIn: prefixer('isElaboratedIn'),

    /**
    * **[todo](http://www.linkedmodel.org/schema/vaem#todo)** (property)
    * 
    ...
    */
    ...
    /**
    * **[Aspect Dimension](http://www.linkedmodel.org/schema/vaem#Aspect)** (class)
    * 
    ...
    */
    ...
    /**
    * **[Domain](http://www.linkedmodel.org/schema/vaem#Dimension)** (class)
    * 
    ...
    */
    ...
    /**
    * **[Graph role](http://www.linkedmodel.org/schema/vaem#GraphRole)** (class)
    * 
    ...
    */
    GraphRole: prefixer('GraphRole'),

    /**
    * **[Discipline Dimension](http://www.linkedmodel.org/schema/vaem#Discipline)** (class)
    * 
    ...
    */
    Discipline: prefixer('Discipline'),

    /**
    * **[Domain Dimension](http://www.linkedmodel.org/schema/vaem#Domain)** (class)
    * 
    ...
    */
    ...
    /**
    * **[Graph Metadata](http://www.linkedmodel.org/schema/vaem#GraphMetaData)** (class)
    * 
    ...
    */
    GraphMetaData: prefixer('GraphMetaData'),

    /**
    * **[Party](http://www.linkedmodel.org/schema/vaem#Party)** (class)
    * 
    ...
    */
    ...
    /**
    * **[ViewpointDimension](http://www.linkedmodel.org/schema/vaem#Viewpoint)** (class)
    * 
    ...
    */
    Viewpoint: prefixer('Viewpoint'),

    /**
    * **[file prefix](http://www.linkedmodel.org/schema/vaem#filePrefix)** (property)
    * 
    ...
    */
    filePrefix: prefixer('filePrefix'),

    /**
    * **[intent](http://www.linkedmodel.org/schema/vaem#intent)** (property)
    * 
    * The property "vaem:intent" is used to outline  a statement of purpose. This typically expresses one or more desired outcomes
    */
    intent: prefixer('intent'),

    /**
    * **[latest published version](http://www.linkedmodel.org/schema/vaem#latestPublishedVersion)** (property)
    * 
    * The property "vaem:latestPublishedVersion"is a URL to documentation for the latest version of a graph.
    */
    latestPublishedVersion: prefixer('latestPublishedVersion'),

    /**
    * **[name](http://www.linkedmodel.org/schema/vaem#name)** (property)
    * 
    ...
    */
    ...
    /**
    * **[namespace](http://www.linkedmodel.org/schema/vaem#namespace)** (property)
    * 
    ...
    */
    ...
    /**
    * **[namespace prefix](http://www.linkedmodel.org/schema/vaem#namespacePrefix)** (property)
    * 
    ...
    */
    namespacePrefix: prefixer('namespacePrefix'),

    /**
    * **[previous published version](http://www.linkedmodel.org/schema/vaem#previousPublishedVersion)** (property)
    * 
    * The property "vaem:previousPublishedVersion"is a URL to documentation for the previous version of a graph.
    */
    previousPublishedVersion: prefixer('previousPublishedVersion'),

    /**
    * **[RDF/XML file URL](http://www.linkedmodel.org/schema/vaem#rdfxmlFileURL)** (property)
    * 
    * The property "vaem:rdfxmlFileURL" is used to provide a link to the location of the ontology's RDF/XML file
    */
    rdfxmlFileURL: prefixer('rdfxmlFileURL'),

    /**
    * **[revision](http://www.linkedmodel.org/schema/vaem#revision)** (property)
    * 
    ...
    */
    ...
    /**
    * **[turtle file URL](http://www.linkedmodel.org/schema/vaem#turtleFileURL)** (property)
    * 
    * The property "vaem:turtleFileURL" is used to provide a link to the location of the ontology's turtle file
    */
    turtleFileURL: prefixer('turtleFileURL'),

    /**
    * **[url](http://www.linkedmodel.org/schema/vaem#url)** (property)
    * 
    ...
    */
    ...
    /**
    * **[abbreviation](http://www.linkedmodel.org/schema/vaem#abbreviation)** (property)
    * 
    ...
    */
    ...
    /**
    * **[acronym](http://www.linkedmodel.org/schema/vaem#acronym)** (property)
    * 
    * The property "vaem:acronym" provides a common way to define a commonly used abbreviation on a resource
    */
    acronym: prefixer('acronym'),

    /**
    * **[date](http://www.linkedmodel.org/schema/vaem#date)** (property)
    * 
    ...
    */
    ...
    /**
    * **[id](http://www.linkedmodel.org/schema/vaem#id)** (property)
    * 
    ...
    */
    ...
    /**
    * **[rationale](http://www.linkedmodel.org/schema/vaem#rationale)** (property)
    * 
    * A description of a justification for some other assertion or value
    */
    rationale: prefixer('rationale'),

    /**
    * **[release date](http://www.linkedmodel.org/schema/vaem#releaseDate)** (property)
    * 
    ...
    */
    ...
    /**
    * **[specificity](http://www.linkedmodel.org/schema/vaem#specificity)** (property)
    * 
    ...
    */
    specificity: prefixer('specificity'),

    /**
    * **[has graph role](http://www.linkedmodel.org/schema/vaem#hasGraphRole)** (property)
    * 
    ...
    */
    hasGraphRole: prefixer('hasGraphRole'),

    /**
    * **[has steward](http://www.linkedmodel.org/schema/vaem#hasSteward)** (property)
    * 
    ...
    */
    hasSteward: prefixer('hasSteward'),

    /**
    * **[has aspect ](http://www.linkedmodel.org/schema/vaem#hasAspect)** (property)
    * 
    ...
    */
    hasAspect: prefixer('hasAspect'),

    /**
    * **[has dimension](http://www.linkedmodel.org/schema/vaem#hasDimension)** (property)
    * 
    ...
    */
    hasDimension: prefixer('hasDimension'),

    /**
    * **[has discipline](http://www.linkedmodel.org/schema/vaem#hasDiscipline)** (property)
    * 
    ...
    */
    hasDiscipline: prefixer('hasDiscipline'),

    /**
    * **[has domain](http://www.linkedmodel.org/schema/vaem#hasDomain)** (property)
    * 
    ...
    */
    hasDomain: prefixer('hasDomain'),

    /**
    * **[has identifier](http://www.linkedmodel.org/schema/vaem#hasIdentifier)** (property)
    * 
    ...
    */
    ...
    /**
    * **[has license type](http://www.linkedmodel.org/schema/vaem#hasLicenseType)** (property)
    * 
    * The property "vaem:hasLicenseType" points to an entry in the VOAG ontology for licenses
    */
    hasLicenseType: prefixer('hasLicenseType'),

    /**
    * **[has metadata](http://www.linkedmodel.org/schema/vaem#hasMetadata)** (property)
    * 
    * The property "hasMetadata" is used to reference a metadata information structure.
    */
    hasMetadata: prefixer('hasMetadata'),

    /**
    * **[has viewpoint](http://www.linkedmodel.org/schema/vaem#hasViewpoint)** (property)
    * 
    ...
    */
    hasViewpoint: prefixer('hasViewpoint'),

    /**
    * **[reifiable by](http://www.linkedmodel.org/schema/vaem#reifiableBy)** (property)
    * 
