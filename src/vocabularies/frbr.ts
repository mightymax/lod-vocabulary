...
const prefixer = $prefixer('http://purl.org/vocab/frbr/core#');
...
const frbr = {
  /**
    * **[concept](http://purl.org/vocab/frbr/core#Concept)** (class)
    * 
    ...
    */
    ...
    /**
    * **[subject](http://purl.org/vocab/frbr/core#Subject)** (class)
    * 
    ...
    */
    ...
    /**
    * **[corporate body](http://purl.org/vocab/frbr/core#CorporateBody)** (class)
    * 
    ...
    */
    ...
    /**
    * **[responsible entity](http://purl.org/vocab/frbr/core#ResponsibleEntity)** (class)
    * 
    ...
    */
    ResponsibleEntity: prefixer('ResponsibleEntity'),

    /**
    * **[person](http://purl.org/vocab/frbr/core#Person)** (class)
    * 
    ...
    */
    ...
    /**
    * **[endeavour](http://purl.org/vocab/frbr/core#Endeavour)** (class)
    * 
    * It describes different aspects of user interests in the products of intellectual or artistic artifact.
    */
    Endeavour: prefixer('Endeavour'),

    /**
    * **[event](http://purl.org/vocab/frbr/core#Event)** (class)
    * 
    ...
    */
    ...
    /**
    * **[expression](http://purl.org/vocab/frbr/core#Expression)** (class)
    * 
    ...
    */
    ...
    /**
    * **[item](http://purl.org/vocab/frbr/core#Item)** (class)
    * 
    ...
    */
    ...
    /**
    * **[manifestation](http://purl.org/vocab/frbr/core#Manifestation)** (class)
    * 
    ...
    */
    Manifestation: prefixer('Manifestation'),

    /**
    * **[work](http://purl.org/vocab/frbr/core#Work)** (class)
    * 
    ...
    */
    ...
    /**
    * **[object](http://purl.org/vocab/frbr/core#Object)** (class)
    * 
    * A material thing.
    * 
    ...
    */
    ...
    /**
    * **[place](http://purl.org/vocab/frbr/core#Place)** (class)
    * 
    * A location.
    * 
    ...
    */
    ...
    /**
    * **[has abridgement](http://purl.org/vocab/frbr/core#abridgement)** (property)
    * 
    ...
    */
    abridgement: prefixer('abridgement'),

    /**
    * **[is abridgement of](http://purl.org/vocab/frbr/core#abridgementOf)** (property)
    * 
    * It identifies the entire expression of an abridged one.
    */
    abridgementOf: prefixer('abridgementOf'),

    /**
    * **[has adaption](http://purl.org/vocab/frbr/core#adaption)** (property)
    * 
    ...
    */
    adaption: prefixer('adaption'),

    /**
    * **[is adaption of](http://purl.org/vocab/frbr/core#adaptionOf)** (property)
    * 
    * It identifies the work/expression of an adapted one.
    */
    adaptionOf: prefixer('adaptionOf'),

    /**
    * **[has alternate](http://purl.org/vocab/frbr/core#alternate)** (property)
    * 
    ...
    */
    alternate: prefixer('alternate'),

    /**
    * **[is alternate of](http://purl.org/vocab/frbr/core#alternateOf)** (property)
    * 
    * It identifies the manifestation of an alternative one.
    */
    alternateOf: prefixer('alternateOf'),

    /**
    * **[has arrangement](http://purl.org/vocab/frbr/core#arrangement)** (property)
    * 
    ...
    */
    arrangement: prefixer('arrangement'),

    /**
    * **[is arrangement of](http://purl.org/vocab/frbr/core#arrangementOf)** (property)
    * 
    * It identifies the original expression of an arranged one.
    */
    arrangementOf: prefixer('arrangementOf'),

    /**
    * **[has complement](http://purl.org/vocab/frbr/core#complement)** (property)
    * 
    ...
    */
    complement: prefixer('complement'),

    /**
    * **[is complement of](http://purl.org/vocab/frbr/core#complementOf)** (property)
    * 
    ...
    */
    ...
    /**
    * **[has creator](http://purl.org/vocab/frbr/core#creator)** (property)
    * 
    ...
    */
    ...
    /**
    * **[has responsible entity](http://purl.org/vocab/frbr/core#responsibleEntity)** (property)
    * 
    ...
    */
    ...
    /**
    * **[is creator of](http://purl.org/vocab/frbr/core#creatorOf)** (property)
    * 
    * The creator of a particular work.
    */
    creatorOf: prefixer('creatorOf'),

    /**
    * **[is responsible entity of](http://purl.org/vocab/frbr/core#responsibleEntityOf)** (property)
    * 
    * An entity that is resposible for a particular endeavour.
    */
    responsibleEntityOf: prefixer('responsibleEntityOf'),

    /**
    * **[has embodiment](http://purl.org/vocab/frbr/core#embodiment)** (property)
    * 
    * An expression embodied in a manifestation.
    */
    embodiment: prefixer('embodiment'),

    /**
    * **[is embodiment of](http://purl.org/vocab/frbr/core#embodimentOf)** (property)
    * 
    * A manifestation that embodies an expression.
    */
    embodimentOf: prefixer('embodimentOf'),

    /**
    * **[has exemplar](http://purl.org/vocab/frbr/core#exemplar)** (property)
    * 
    * A manifestation exemplified in an item.
    */
    exemplar: prefixer('exemplar'),

    /**
    * **[is exemplar of](http://purl.org/vocab/frbr/core#exemplarOf)** (property)
    * 
    * An item that exemplifies a manifestation.
    */
    exemplarOf: prefixer('exemplarOf'),

    /**
    * **[has imitation](http://purl.org/vocab/frbr/core#imitation)** (property)
    * 
    ...
    */
    imitation: prefixer('imitation'),

    /**
    * **[is imitation of](http://purl.org/vocab/frbr/core#imitationOf)** (property)
    * 
    * It identifies the work/expression of an imitated one.
    */
    imitationOf: prefixer('imitationOf'),

    /**
    * **[has owner](http://purl.org/vocab/frbr/core#owner)** (property)
    * 
    ...
    */
    ...
    /**
    * **[is owner of](http://purl.org/vocab/frbr/core#ownerOf)** (property)
    * 
    * The owner of a particular item.
    */
    ownerOf: prefixer('ownerOf'),

    /**
    * **[has part](http://purl.org/vocab/frbr/core#part)** (property)
    * 
    ...
    */
    ...
    /**
    * **[is part of](http://purl.org/vocab/frbr/core#partOf)** (property)
    * 
    * An endeavour incorporating another endeavour.
    */
    partOf: prefixer('partOf'),

    /**
    * **[has producer](http://purl.org/vocab/frbr/core#producer)** (property)
    * 
    ...
    */
    ...
    /**
    * **[is producer of](http://purl.org/vocab/frbr/core#producerOf)** (property)
    * 
    * The producer of a particular manifestation.
    */
    producerOf: prefixer('producerOf'),

    /**
    * **[has realization](http://purl.org/vocab/frbr/core#realization)** (property)
    * 
    * A work realized through an expression.
    */
    realization: prefixer('realization'),

    /**
    * **[is realization of](http://purl.org/vocab/frbr/core#realizationOf)** (property)
    * 
    * An expression that realizes a work.
    */
    realizationOf: prefixer('realizationOf'),

    /**
    * **[has realizer](http://purl.org/vocab/frbr/core#realizer)** (property)
    * 
    * An expression linked to its realizer.
    */
    realizer: prefixer('realizer'),

    /**
    * **[is realizer of](http://purl.org/vocab/frbr/core#realizerOf)** (property)
    * 
    * The realizer of a particular expression.
    */
    realizerOf: prefixer('realizerOf'),

    /**
    * **[has reconfiguration](http://purl.org/vocab/frbr/core#reconfiguration)** (property)
    * 
    ...
    */
    reconfiguration: prefixer('reconfiguration'),

    /**
    * **[is reconfiguration of](http://purl.org/vocab/frbr/core#reconfigurationOf)** (property)
    * 
    * It identifies the manifestation of a reconfigured one.
    */
    reconfigurationOf: prefixer('reconfigurationOf'),

    /**
    * **[has reproduction](http://purl.org/vocab/frbr/core#reproduction)** (property)
    * 
    ...
    */
    reproduction: prefixer('reproduction'),

    /**
    * **[is reproduction of](http://purl.org/vocab/frbr/core#reproductionOf)** (property)
    * 
    * It identifies the manifestation/item of a reproduced one.
    */
    reproductionOf: prefixer('reproductionOf'),

    /**
    * **[has revision](http://purl.org/vocab/frbr/core#revision)** (property)
    * 
    ...
    */
    ...
    /**
    * **[is revision of](http://purl.org/vocab/frbr/core#revisionOf)** (property)
    * 
    * It identifies the previous expression of a revised one.
    */
    revisionOf: prefixer('revisionOf'),

    /**
    * **[has subject](http://purl.org/vocab/frbr/core#subject)** (property)
    * 
    ...
    */
    ...
    /**
    * **[is subject of](http://purl.org/vocab/frbr/core#subjectOf)** (property)
    * 
    ...
    */
    ...
    /**
    * **[has successor](http://purl.org/vocab/frbr/core#successor)** (property)
    * 
    ...
    */
    successor: prefixer('successor'),

    /**
    * **[is successor of](http://purl.org/vocab/frbr/core#successorOf)** (property)
    * 
    ...
    */
    ...
    /**
    * **[has summarization](http://purl.org/vocab/frbr/core#summarization)** (property)
    * 
    ...
    */
    summarization: prefixer('summarization'),

    /**
    * **[is summarization of](http://purl.org/vocab/frbr/core#summarizationOf)** (property)
    * 
    * It identifies the original work/expression of a summarized one.
    */
    summarizationOf: prefixer('summarizationOf'),

    /**
    * **[has supplement](http://purl.org/vocab/frbr/core#supplement)** (property)
    * 
    ...
    */
    supplement: prefixer('supplement'),

    /**
    * **[is supplement of](http://purl.org/vocab/frbr/core#supplementOf)** (property)
    * 
    * It identifies the work/expression of a particular supplement of it.
    */
    supplementOf: prefixer('supplementOf'),

    /**
    * **[has transformation](http://purl.org/vocab/frbr/core#transformation)** (property)
    * 
    ...
    */
    ...
    /**
    * **[is transformation of](http://purl.org/vocab/frbr/core#transformationOf)** (property)
    * 
    * It identifies the original work/expression of a trasformed one.
    */
    transformationOf: prefixer('transformationOf'),

    /**
    * **[has translation](http://purl.org/vocab/frbr/core#translation)** (property)
    * 
    ...
    */
    ...
    /**
    * **[is translation of](http://purl.org/vocab/frbr/core#translationOf)** (property)
    * 
