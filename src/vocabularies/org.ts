...
const prefixer = $prefixer('http://www.w3.org/ns/org#');
...
const org = {
  /**
    * **[Formal Organization](http://www.w3.org/ns/org#FormalOrganization)** (class)
    * 
    ...
    */
    FormalOrganization: prefixer('FormalOrganization'),

    /**
    * **[Change Event](http://www.w3.org/ns/org#ChangeEvent)** (class)
    * 
    ...
    */
    ChangeEvent: prefixer('ChangeEvent'),

    /**
    * **[Organization](http://www.w3.org/ns/org#Organization)** (class)
    * 
    ...
    */
    ...
    /**
    * **[Role](http://www.w3.org/ns/org#Role)** (class)
    * 
    ...
    */
    ...
    /**
    * **[Membership](http://www.w3.org/ns/org#Membership)** (class)
    * 
    ...
    */
    Membership: prefixer('Membership'),

    /**
    * **[Site](http://www.w3.org/ns/org#Site)** (class)
    * 
    ...
    */
    ...
    /**
    * **[Endeavour](http://www.w3.org/ns/org#OrganizationalCollaboration)** (class)
    * 
    ...
    */
    OrganizationalCollaboration: prefixer('OrganizationalCollaboration'),

    /**
    * **[OrganizationalUnit](http://www.w3.org/ns/org#OrganizationalUnit)** (class)
    * 
    ...
    */
    OrganizationalUnit: prefixer('OrganizationalUnit'),

    /**
    * **[Post](http://www.w3.org/ns/org#Post)** (class)
    * 
    ...
    */
    ...
    /**
    * **[role (property)](http://www.w3.org/ns/org#roleProperty)** (property)
    * 
    ...
    */
    roleProperty: prefixer('roleProperty'),

    /**
    * **[head of](http://www.w3.org/ns/org#headOf)** (property)
    * 
    ...
    */
    headOf: prefixer('headOf'),

    /**
    * **[based At](http://www.w3.org/ns/org#basedAt)** (property)
    * 
    ...
    */
    basedAt: prefixer('basedAt'),

    /**
    * **[changed by](http://www.w3.org/ns/org#changedBy)** (property)
    * 
    ...
    */
    changedBy: prefixer('changedBy'),

    /**
    * **[original organization](http://www.w3.org/ns/org#originalOrganization)** (property)
    * 
    ...
    */
    originalOrganization: prefixer('originalOrganization'),

    /**
    * **[classification](http://www.w3.org/ns/org#classification)** (property)
    * 
    ...
    */
    ...
    /**
    * **[has member](http://www.w3.org/ns/org#hasMember)** (property)
    * 
    ...
    */
    ...
    /**
    * **[member of](http://www.w3.org/ns/org#memberOf)** (property)
    * 
    ...
    */
    ...
    /**
    * **[membership](http://www.w3.org/ns/org#hasMembership)** (property)
    * 
    * Indicates a membership relationship that the Agent plays. Inverse of `org:member`.
    */
    hasMembership: prefixer('hasMembership'),

    /**
    * **[member](http://www.w3.org/ns/org#member)** (property)
    * 
    ...
    */
    ...
    /**
    * **[post](http://www.w3.org/ns/org#hasPost)** (property)
    * 
    * Indicates a Post which exists within the Organization.
    */
    hasPost: prefixer('hasPost'),

    /**
    * **[primary Site](http://www.w3.org/ns/org#hasPrimarySite)** (property)
    * 
    ...
    */
    hasPrimarySite: prefixer('hasPrimarySite'),

    /**
    * **[has site](http://www.w3.org/ns/org#hasSite)** (property)
    * 
    ...
    */
    hasSite: prefixer('hasSite'),

    /**
    * **[registered Site](http://www.w3.org/ns/org#hasRegisteredSite)** (property)
    * 
    ...
    */
    hasRegisteredSite: prefixer('hasRegisteredSite'),

    /**
    * **[site Of](http://www.w3.org/ns/org#siteOf)** (property)
    * 
    * Indicates an Organization which has some presence at the given site. This is the inverse of `org:hasSite`.
    */
    siteOf: prefixer('siteOf'),

    /**
    * **[has SubOrganization](http://www.w3.org/ns/org#hasSubOrganization)** (property)
    * 
    ...
    */
    hasSubOrganization: prefixer('hasSubOrganization'),

    /**
    * **[subOrganization of](http://www.w3.org/ns/org#subOrganizationOf)** (property)
    * 
    ...
    */
    subOrganizationOf: prefixer('subOrganizationOf'),

    /**
    * **[has Unit](http://www.w3.org/ns/org#hasUnit)** (property)
    * 
    ...
    */
    ...
    /**
    * **[unit Of](http://www.w3.org/ns/org#unitOf)** (property)
    * 
    ...
    */
    unitOf: prefixer('unitOf'),

    /**
    * **[held by](http://www.w3.org/ns/org#heldBy)** (property)
    * 
    * Indicates an Agent which holds a Post.
    */
    heldBy: prefixer('heldBy'),

    /**
    * **[holds](http://www.w3.org/ns/org#holds)** (property)
    * 
    * Indicates a Post held by some Agent.
    */
    holds: prefixer('holds'),

    /**
    * **[identifier](http://www.w3.org/ns/org#identifier)** (property)
    * 
    ...
    */
    ...
    /**
    * **[linked to](http://www.w3.org/ns/org#linkedTo)** (property)
    * 
    ...
    */
    linkedTo: prefixer('linkedTo'),

    /**
    * **[location](http://www.w3.org/ns/org#location)** (property)
    * 
    ...
    */
    ...
    /**
    * **[member During](http://www.w3.org/ns/org#memberDuring)** (property)
    * 
    * Optional property to indicate the interval for which the membership is/was valid.
    */
    memberDuring: prefixer('memberDuring'),

    /**
    * **[organization](http://www.w3.org/ns/org#organization)** (property)
    * 
    ...
    */
    ...
    /**
    * **[post in](http://www.w3.org/ns/org#postIn)** (property)
    * 
    * Indicates the Organization in which the Post exists.
    */
    postIn: prefixer('postIn'),

    /**
    * **[purpose](http://www.w3.org/ns/org#purpose)** (property)
    * 
    ...
    */
    ...
    /**
    * **[remuneration](http://www.w3.org/ns/org#remuneration)** (property)
    * 
    ...
    */
    remuneration: prefixer('remuneration'),

    /**
    * **[reports to](http://www.w3.org/ns/org#reportsTo)** (property)
    * 
    ...
    */
    reportsTo: prefixer('reportsTo'),

    /**
    * **[resulted from](http://www.w3.org/ns/org#resultedFrom)** (property)
    * 
    * Indicates an event which resulted in this organization. Inverse of `org:resultingOrganization`.
    */
    resultedFrom: prefixer('resultedFrom'),

    /**
    * **[resulted in](http://www.w3.org/ns/org#resultingOrganization)** (property)
    * 
    * Indicates an organization which was created or changed as a result of the event. Inverse of `org:resultedFrom`.
    */
    resultingOrganization: prefixer('resultingOrganization'),

    /**
    * **[role](http://www.w3.org/ns/org#role)** (property)
    * 
    ...
    */
    ...
    /**
    * **[site Address](http://www.w3.org/ns/org#siteAddress)** (property)
    * 
    ...
    */
    siteAddress: prefixer('siteAddress'),

    /**
    * **[transitive sub-organization](http://www.w3.org/ns/org#transitiveSubOrganizationOf)** (property)
    * 
    ...
    */
    transitiveSubOrganizationOf: prefixer('transitiveSubOrganizationOf'),
