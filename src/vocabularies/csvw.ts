...
const prefixer = $prefixer('http://www.w3.org/ns/csvw#');
...
const csvw = {
  /**
    * **[Cell](http://www.w3.org/ns/csvw#Cell)** (class)
    * 
    ...
    */
    ...
    /**
    * **[Column Description](http://www.w3.org/ns/csvw#Column)** (class)
    * 
    ...
    */
    ...
    /**
    * **[Datatype](http://www.w3.org/ns/csvw#Datatype)** (class)
    * 
    ...
    */
    ...
    /**
    * **[Dialect Description](http://www.w3.org/ns/csvw#Dialect)** (class)
    * 
    ...
    */
    ...
    /**
    * **[Direction](http://www.w3.org/ns/csvw#Direction)** (class)
    * 
    ...
    */
    ...
    /**
    * **[Foreign Key Definition](http://www.w3.org/ns/csvw#ForeignKey)** (class)
    * 
    * Describes relationships between Columns in one or more Tables.
    */
    ForeignKey: prefixer('ForeignKey'),

    /**
    * **[Numeric Format](http://www.w3.org/ns/csvw#NumericFormat)** (class)
    * 
    ...
    */
    NumericFormat: prefixer('NumericFormat'),

    /**
    * **[Row](http://www.w3.org/ns/csvw#Row)** (class)
    * 
    ...
    */
    ...
    /**
    * **[Schema](http://www.w3.org/ns/csvw#Schema)** (class)
    * 
    ...
    */
    ...
    /**
    * **[Annotated Table](http://www.w3.org/ns/csvw#Table)** (class)
    * 
    ...
    */
    ...
    /**
    * **[Group of Tables](http://www.w3.org/ns/csvw#TableGroup)** (class)
    * 
    * A Group of Tables comprises a set of Annotated Tables and a set of annotations that relate to those Tables.
    */
    TableGroup: prefixer('TableGroup'),

    /**
    * **[Table Reference](http://www.w3.org/ns/csvw#TableReference)** (class)
    * 
    * An object property that identifies a referenced table and a set of referenced columns within that table.
    */
    TableReference: prefixer('TableReference'),

    /**
    * **[Transformation Definition](http://www.w3.org/ns/csvw#Transformation)** (class)
    * 
    ...
    */
    ...
    /**
    * **[about URL](http://www.w3.org/ns/csvw#aboutUrl)** (property)
    * 
    * A URI template property that MAY be used to indicate what a cell contains information about.
    */
    aboutUrl: prefixer('aboutUrl'),

    /**
    * **[base](http://www.w3.org/ns/csvw#base)** (property)
    * 
    ...
    */
    ...
    /**
    * **[column](http://www.w3.org/ns/csvw#column)** (property)
    * 
    ...
    */
    ...
    /**
    * **[column reference](http://www.w3.org/ns/csvw#columnReference)** (property)
    * 
    ...
    */
    columnReference: prefixer('columnReference'),

    /**
    * **[comment prefix](http://www.w3.org/ns/csvw#commentPrefix)** (property)
    * 
    * An atomic property that sets the comment prefix flag to the single provided value, which MUST be a string.
    */
    commentPrefix: prefixer('commentPrefix'),

    /**
    * **[datatype](http://www.w3.org/ns/csvw#datatype)** (property)
    * 
    ...
    */
    ...
    /**
    * **[decimal character](http://www.w3.org/ns/csvw#decimalChar)** (property)
    * 
    * A string whose value is used to represent a decimal point within the number.
    */
    decimalChar: prefixer('decimalChar'),

    /**
    * **[default](http://www.w3.org/ns/csvw#default)** (property)
    * 
    ...
    */
    ...
    /**
    * **[delimiter](http://www.w3.org/ns/csvw#delimiter)** (property)
    * 
    * An atomic property that sets the delimiter flag to the single provided value, which MUST be a string.
    */
    delimiter: prefixer('delimiter'),

    /**
    * **[describes](http://www.w3.org/ns/csvw#describes)** (property)
    * 
    ...
    */
    ...
    /**
    * **[dialect](http://www.w3.org/ns/csvw#dialect)** (property)
    * 
    ...
    */
    ...
    /**
    * **[double quote](http://www.w3.org/ns/csvw#doubleQuote)** (property)
    * 
    * A boolean atomic property that, if `true`, sets the escape character flag to `"`.
    */
    doubleQuote: prefixer('doubleQuote'),

    /**
    * **[encoding](http://www.w3.org/ns/csvw#encoding)** (property)
    * 
    ...
    */
    ...
    /**
    * **[foreign key](http://www.w3.org/ns/csvw#foreignKey)** (property)
    * 
    ...
    */
    ...
    /**
    * **[format](http://www.w3.org/ns/csvw#format)** (property)
    * 
    ...
    */
    ...
    /**
    * **[group character](http://www.w3.org/ns/csvw#groupChar)** (property)
    * 
    * A string whose value is used to group digits within the number.
    */
    groupChar: prefixer('groupChar'),

    /**
    * **[header](http://www.w3.org/ns/csvw#header)** (property)
    * 
    ...
    */
    header: prefixer('header'),

    /**
    * **[header row count](http://www.w3.org/ns/csvw#headerRowCount)** (property)
    * 
    ...
    */
    headerRowCount: prefixer('headerRowCount'),

    /**
    * **[language](http://www.w3.org/ns/csvw#lang)** (property)
    * 
    ...
    */
    ...
    /**
    * **[length](http://www.w3.org/ns/csvw#length)** (property)
    * 
    ...
    */
    ...
    /**
    * **[line terminators](http://www.w3.org/ns/csvw#lineTerminators)** (property)
    * 
    ...
    */
    lineTerminators: prefixer('lineTerminators'),

    /**
    * **[max exclusive](http://www.w3.org/ns/csvw#maxExclusive)** (property)
    * 
    ...
    */
    ...
    /**
    * **[max inclusive](http://www.w3.org/ns/csvw#maxInclusive)** (property)
    * 
    ...
    */
    ...
    /**
    * **[max length](http://www.w3.org/ns/csvw#maxLength)** (property)
    * 
    ...
    */
    ...
    /**
    * **[min exclusive](http://www.w3.org/ns/csvw#minExclusive)** (property)
    * 
    ...
    */
    ...
    /**
    * **[min inclusive](http://www.w3.org/ns/csvw#minInclusive)** (property)
    * 
    ...
    */
    ...
    /**
    * **[min length](http://www.w3.org/ns/csvw#minLength)** (property)
    * 
    ...
    */
    ...
    /**
    * **[name](http://www.w3.org/ns/csvw#name)** (property)
    * 
    ...
    */
    ...
    /**
    * **[note](http://www.w3.org/ns/csvw#note)** (property)
    * 
    ...
    */
    ...
    /**
    * **[null](http://www.w3.org/ns/csvw#null)** (property)
    * 
    ...
    */
    ...
    /**
    * **[ordered](http://www.w3.org/ns/csvw#ordered)** (property)
    * 
    ...
    */
    ordered: prefixer('ordered'),

    /**
    * **[pattern](http://www.w3.org/ns/csvw#pattern)** (property)
    * 
    ...
    */
    ...
    /**
    * **[primary key](http://www.w3.org/ns/csvw#primaryKey)** (property)
    * 
    ...
    */
    primaryKey: prefixer('primaryKey'),

    /**
    * **[property URL](http://www.w3.org/ns/csvw#propertyUrl)** (property)
    * 
    * An URI template property that MAY be used to create a URI for a property if the table is mapped to another format.
    */
    propertyUrl: prefixer('propertyUrl'),

    /**
    * **[quote char](http://www.w3.org/ns/csvw#quoteChar)** (property)
    * 
    * An atomic property that sets the quote character flag to the single provided value, which must be a string or `null`.
    */
    quoteChar: prefixer('quoteChar'),

    /**
    * **[reference](http://www.w3.org/ns/csvw#reference)** (property)
    * 
    * An object property that identifies a **referenced table** and a set of **referenced columns** within that table.
    */
    ...
    /**
    * **[referenced rows](http://www.w3.org/ns/csvw#referencedRow)** (property)
    * 
    * A possibly empty list of pairs of a foreign key and a row in a table within the same group of tables.
    */
    referencedRow: prefixer('referencedRow'),

    /**
    * **[required](http://www.w3.org/ns/csvw#required)** (property)
    * 
    ...
    */
    ...
    /**
    * **[resource](http://www.w3.org/ns/csvw#resource)** (property)
    * 
    ...
    */
    ...
    /**
    * **[row](http://www.w3.org/ns/csvw#row)** (property)
    * 
    ...
    */
    ...
    /**
    * **[row titles](http://www.w3.org/ns/csvw#rowTitle)** (property)
    * 
    * A column reference property that holds either a single reference to a column description object or an array of references.
    */
    rowTitle: prefixer('rowTitle'),

    /**
    * **[row number](http://www.w3.org/ns/csvw#rownum)** (property)
    * 
    * The position of the row amongst the rows of the Annotated Tabl, starting from 1
    */
    rownum: prefixer('rownum'),

    /**
    * **[schema reference](http://www.w3.org/ns/csvw#schemaReference)** (property)
    * 
    * A link property holding a URL that is the identifier for a schema that is being referenced.
    */
    schemaReference: prefixer('schemaReference'),

    /**
    * **[script format](http://www.w3.org/ns/csvw#scriptFormat)** (property)
    * 
    * A link property giving the single URL for the format that is used by the script or template.
    */
    scriptFormat: prefixer('scriptFormat'),

    /**
    * **[separator](http://www.w3.org/ns/csvw#separator)** (property)
    * 
    ...
    */
    separator: prefixer('separator'),

    /**
    * **[skip blank rows](http://www.w3.org/ns/csvw#skipBlankRows)** (property)
    * 
    * An boolean atomic property that sets the `skip blank rows` flag to the single provided boolean value.
    */
    skipBlankRows: prefixer('skipBlankRows'),

    /**
    * **[skip columns](http://www.w3.org/ns/csvw#skipColumns)** (property)
    * 
    ...
    */
    skipColumns: prefixer('skipColumns'),

    /**
    * **[skip initial space](http://www.w3.org/ns/csvw#skipInitialSpace)** (property)
    * 
    * A boolean atomic property that, if `true`, sets the trim flag to "start". If `false`, to `false`.
    */
    skipInitialSpace: prefixer('skipInitialSpace'),

    /**
    * **[skip rows](http://www.w3.org/ns/csvw#skipRows)** (property)
    * 
    ...
    */
    skipRows: prefixer('skipRows'),

    /**
    * **[source](http://www.w3.org/ns/csvw#source)** (property)
    * 
    ...
    */
    ...
    /**
    * **[suppress output](http://www.w3.org/ns/csvw#suppressOutput)** (property)
    * 
    ...
    */
    suppressOutput: prefixer('suppressOutput'),

    /**
    * **[table](http://www.w3.org/ns/csvw#table)** (property)
    * 
    ...
    */
    ...
    /**
    * **[table direction](http://www.w3.org/ns/csvw#tableDirection)** (property)
    * 
    ...
    */
    tableDirection: prefixer('tableDirection'),

    /**
    * **[table schema](http://www.w3.org/ns/csvw#tableSchema)** (property)
    * 
    ...
    */
    tableSchema: prefixer('tableSchema'),

    /**
    * **[target format](http://www.w3.org/ns/csvw#targetFormat)** (property)
    * 
    * A link property giving the single URL for the format that will be created through the transformation.
    */
    targetFormat: prefixer('targetFormat'),

    /**
    * **[text direction](http://www.w3.org/ns/csvw#textDirection)** (property)
    * 
    ...
    */
    ...
    /**
    * **[title](http://www.w3.org/ns/csvw#title)** (property)
    * 
    ...
    */
    ...
    /**
    * **[transformations](http://www.w3.org/ns/csvw#transformations)** (property)
    * 
    * An array property of transformation definitions that provide mechanisms to transform the tabular data into other formats.
    */
    transformations: prefixer('transformations'),

    /**
    * **[trim](http://www.w3.org/ns/csvw#trim)** (property)
    * 
    ...
    */
    ...
    /**
    * **[url](http://www.w3.org/ns/csvw#url)** (property)
    * 
    ...
    */
    ...
    /**
    * **[valueUrl](http://www.w3.org/ns/csvw#valueUrl)** (property)
    * 
    * An URI template property that is used to map the values of cells into URLs.
    */
    valueUrl: prefixer('valueUrl'),

    /**
    * **[virtual](http://www.w3.org/ns/csvw#virtual)** (property)
    * 
