...
const prefixer = $prefixer('http://www.cidoc-crm.org/cidoc-crm/');
...
const crm = {
  /**
    * **[Transfer of Custody](http://www.cidoc-crm.org/cidoc-crm/E10_Transfer_of_Custody)** (class)
    * 
    ...
    */
    E10_Transfer_of_Custody: prefixer('E10_Transfer_of_Custody'),

    /**
    * **[Activity](http://www.cidoc-crm.org/cidoc-crm/E7_Activity)** (class)
    * 
    ...
    */
    E7_Activity: prefixer('E7_Activity'),

    /**
    * **[Modification](http://www.cidoc-crm.org/cidoc-crm/E11_Modification)** (class)
    * 
    ...
    */
    E11_Modification: prefixer('E11_Modification'),

    /**
    * **[Production](http://www.cidoc-crm.org/cidoc-crm/E12_Production)** (class)
    * 
    ...
    */
    E12_Production: prefixer('E12_Production'),

    /**
    * **[Beginning of Existence](http://www.cidoc-crm.org/cidoc-crm/E63_Beginning_of_Existence)** (class)
    * 
    ...
    */
    E63_Beginning_of_Existence: prefixer('E63_Beginning_of_Existence'),

    /**
    * **[Attribute Assignment](http://www.cidoc-crm.org/cidoc-crm/E13_Attribute_Assignment)** (class)
    * 
    ...
    */
    E13_Attribute_Assignment: prefixer('E13_Attribute_Assignment'),

    /**
    * **[Condition Assessment](http://www.cidoc-crm.org/cidoc-crm/E14_Condition_Assessment)** (class)
    * 
    ...
    */
    E14_Condition_Assessment: prefixer('E14_Condition_Assessment'),

    /**
    * **[Identifier Assignment](http://www.cidoc-crm.org/cidoc-crm/E15_Identifier_Assignment)** (class)
    * 
    ...
    */
    E15_Identifier_Assignment: prefixer('E15_Identifier_Assignment'),

    /**
    * **[Measurement](http://www.cidoc-crm.org/cidoc-crm/E16_Measurement)** (class)
    * 
    ...
    */
    E16_Measurement: prefixer('E16_Measurement'),

    /**
    * **[Type Assignment](http://www.cidoc-crm.org/cidoc-crm/E17_Type_Assignment)** (class)
    * 
    ...
    */
    E17_Type_Assignment: prefixer('E17_Type_Assignment'),

    /**
    * **[Physical Thing](http://www.cidoc-crm.org/cidoc-crm/E18_Physical_Thing)** (class)
    * 
    ...
    */
    E18_Physical_Thing: prefixer('E18_Physical_Thing'),

    /**
    * **[Legal Object](http://www.cidoc-crm.org/cidoc-crm/E72_Legal_Object)** (class)
    * 
    ...
    */
    E72_Legal_Object: prefixer('E72_Legal_Object'),

    /**
    * **[Physical Object](http://www.cidoc-crm.org/cidoc-crm/E19_Physical_Object)** (class)
    * 
    ...
    */
    E19_Physical_Object: prefixer('E19_Physical_Object'),

    /**
    * **[CRM Entity](http://www.cidoc-crm.org/cidoc-crm/E1_CRM_Entity)** (class)
    * 
    ...
    */
    E1_CRM_Entity: prefixer('E1_CRM_Entity'),

    /**
    * **[Biological Object](http://www.cidoc-crm.org/cidoc-crm/E20_Biological_Object)** (class)
    * 
    ...
    */
    E20_Biological_Object: prefixer('E20_Biological_Object'),

    /**
    * **[Person](http://www.cidoc-crm.org/cidoc-crm/E21_Person)** (class)
    * 
    ...
    */
    E21_Person: prefixer('E21_Person'),

    /**
    * **[Actor](http://www.cidoc-crm.org/cidoc-crm/E39_Actor)** (class)
    * 
    ...
    */
    E39_Actor: prefixer('E39_Actor'),

    /**
    * **[Human-Made Object](http://www.cidoc-crm.org/cidoc-crm/E22_Human-Made_Object)** (class)
    * 
    ...
    */
    'E22_Human-Made_Object': prefixer('E22_Human-Made_Object'),

    /**
    * **[Physical Human-Made Thing](http://www.cidoc-crm.org/cidoc-crm/E24_Physical_Human-Made_Thing)** (class)
    * 
    ...
    */
    'E24_Physical_Human-Made_Thing': prefixer('E24_Physical_Human-Made_Thing'),

    /**
    * **[Human-Made Thing](http://www.cidoc-crm.org/cidoc-crm/E71_Human-Made_Thing)** (class)
    * 
    ...
    */
    'E71_Human-Made_Thing': prefixer('E71_Human-Made_Thing'),

    /**
    * **[Human-Made Feature](http://www.cidoc-crm.org/cidoc-crm/E25_Human-Made_Feature)** (class)
    * 
    ...
    */
    'E25_Human-Made_Feature': prefixer('E25_Human-Made_Feature'),

    /**
    * **[Physical Feature](http://www.cidoc-crm.org/cidoc-crm/E26_Physical_Feature)** (class)
    * 
    ...
    */
    E26_Physical_Feature: prefixer('E26_Physical_Feature'),

    /**
    * **[Site](http://www.cidoc-crm.org/cidoc-crm/E27_Site)** (class)
    * 
    ...
    */
    E27_Site: prefixer('E27_Site'),

    /**
    * **[Conceptual Object](http://www.cidoc-crm.org/cidoc-crm/E28_Conceptual_Object)** (class)
    * 
    ...
    */
    E28_Conceptual_Object: prefixer('E28_Conceptual_Object'),

    /**
    * **[Design or Procedure](http://www.cidoc-crm.org/cidoc-crm/E29_Design_or_Procedure)** (class)
    * 
    ...
    */
    E29_Design_or_Procedure: prefixer('E29_Design_or_Procedure'),

    /**
    * **[Information Object](http://www.cidoc-crm.org/cidoc-crm/E73_Information_Object)** (class)
    * 
    ...
    */
    E73_Information_Object: prefixer('E73_Information_Object'),

    /**
    * **[Temporal Entity](http://www.cidoc-crm.org/cidoc-crm/E2_Temporal_Entity)** (class)
    * 
    ...
    */
    E2_Temporal_Entity: prefixer('E2_Temporal_Entity'),

    /**
    * **[Right](http://www.cidoc-crm.org/cidoc-crm/E30_Right)** (class)
    * 
    ...
    */
    E30_Right: prefixer('E30_Right'),

    /**
    * **[Propositional Object](http://www.cidoc-crm.org/cidoc-crm/E89_Propositional_Object)** (class)
    * 
    ...
    */
    E89_Propositional_Object: prefixer('E89_Propositional_Object'),

    /**
    * **[Document](http://www.cidoc-crm.org/cidoc-crm/E31_Document)** (class)
    * 
    ...
    */
    E31_Document: prefixer('E31_Document'),

    /**
    * **[Authority Document](http://www.cidoc-crm.org/cidoc-crm/E32_Authority_Document)** (class)
    * 
    ...
    */
    E32_Authority_Document: prefixer('E32_Authority_Document'),

    /**
    * **[Linguistic Object](http://www.cidoc-crm.org/cidoc-crm/E33_Linguistic_Object)** (class)
    * 
    ...
    */
    E33_Linguistic_Object: prefixer('E33_Linguistic_Object'),

    /**
    * **[Appellation](http://www.cidoc-crm.org/cidoc-crm/E41_Appellation)** (class)
    * 
    ...
    */
    E41_Appellation: prefixer('E41_Appellation'),

    /**
    * **[Inscription](http://www.cidoc-crm.org/cidoc-crm/E34_Inscription)** (class)
    * 
    ...
    */
    E34_Inscription: prefixer('E34_Inscription'),

    /**
    * **[Mark](http://www.cidoc-crm.org/cidoc-crm/E37_Mark)** (class)
    * 
    ...
    */
    E37_Mark: prefixer('E37_Mark'),

    /**
    * **[Title](http://www.cidoc-crm.org/cidoc-crm/E35_Title)** (class)
    * 
    ...
    */
    E35_Title: prefixer('E35_Title'),

    /**
    * **[Visual Item](http://www.cidoc-crm.org/cidoc-crm/E36_Visual_Item)** (class)
    * 
    ...
    */
    E36_Visual_Item: prefixer('E36_Visual_Item'),

    /**
    * **[Persistent Item](http://www.cidoc-crm.org/cidoc-crm/E77_Persistent_Item)** (class)
    * 
    ...
    */
    E77_Persistent_Item: prefixer('E77_Persistent_Item'),

    /**
    * **[Condition State](http://www.cidoc-crm.org/cidoc-crm/E3_Condition_State)** (class)
    * 
    ...
    */
    E3_Condition_State: prefixer('E3_Condition_State'),

    /**
    * **[Symbolic Object](http://www.cidoc-crm.org/cidoc-crm/E90_Symbolic_Object)** (class)
    * 
    ...
    */
    E90_Symbolic_Object: prefixer('E90_Symbolic_Object'),

    /**
    * **[Identifier](http://www.cidoc-crm.org/cidoc-crm/E42_Identifier)** (class)
    * 
    ...
    */
    E42_Identifier: prefixer('E42_Identifier'),

    /**
    * **[Period](http://www.cidoc-crm.org/cidoc-crm/E4_Period)** (class)
    * 
    ...
    */
    E4_Period: prefixer('E4_Period'),

    /**
    * **[Spacetime Volume](http://www.cidoc-crm.org/cidoc-crm/E92_Spacetime_Volume)** (class)
    * 
    ...
    */
    E92_Spacetime_Volume: prefixer('E92_Spacetime_Volume'),

    /**
    * **[Time-Span](http://www.cidoc-crm.org/cidoc-crm/E52_Time-Span)** (class)
    * 
    ...
    */
    'E52_Time-Span': prefixer('E52_Time-Span'),

    /**
    * **[Place](http://www.cidoc-crm.org/cidoc-crm/E53_Place)** (class)
    * 
    ...
    */
    E53_Place: prefixer('E53_Place'),

    /**
    * **[Dimension](http://www.cidoc-crm.org/cidoc-crm/E54_Dimension)** (class)
    * 
    ...
    */
    E54_Dimension: prefixer('E54_Dimension'),

    /**
    * **[Type](http://www.cidoc-crm.org/cidoc-crm/E55_Type)** (class)
    * 
    ...
    */
    E55_Type: prefixer('E55_Type'),

    /**
    * **[Language](http://www.cidoc-crm.org/cidoc-crm/E56_Language)** (class)
    * 
    ...
    */
    E56_Language: prefixer('E56_Language'),

    /**
    * **[Material](http://www.cidoc-crm.org/cidoc-crm/E57_Material)** (class)
    * 
    ...
    */
    E57_Material: prefixer('E57_Material'),

    /**
    * **[Measurement Unit](http://www.cidoc-crm.org/cidoc-crm/E58_Measurement_Unit)** (class)
    * 
    ...
    */
    E58_Measurement_Unit: prefixer('E58_Measurement_Unit'),

    /**
    * **[Event](http://www.cidoc-crm.org/cidoc-crm/E5_Event)** (class)
    * 
    ...
    */
    E5_Event: prefixer('E5_Event'),

    /**
    * **[End of Existence](http://www.cidoc-crm.org/cidoc-crm/E64_End_of_Existence)** (class)
    * 
    ...
    */
    E64_End_of_Existence: prefixer('E64_End_of_Existence'),

    /**
    * **[Creation](http://www.cidoc-crm.org/cidoc-crm/E65_Creation)** (class)
    * 
    ...
    */
    E65_Creation: prefixer('E65_Creation'),

    /**
    * **[Formation](http://www.cidoc-crm.org/cidoc-crm/E66_Formation)** (class)
    * 
    ...
    */
    E66_Formation: prefixer('E66_Formation'),

    /**
    * **[Birth](http://www.cidoc-crm.org/cidoc-crm/E67_Birth)** (class)
    * 
    ...
    */
    E67_Birth: prefixer('E67_Birth'),

    /**
    * **[Dissolution](http://www.cidoc-crm.org/cidoc-crm/E68_Dissolution)** (class)
    * 
    ...
    */
    E68_Dissolution: prefixer('E68_Dissolution'),

    /**
    * **[Death](http://www.cidoc-crm.org/cidoc-crm/E69_Death)** (class)
    * 
    ...
    */
    E69_Death: prefixer('E69_Death'),

    /**
    * **[Destruction](http://www.cidoc-crm.org/cidoc-crm/E6_Destruction)** (class)
    * 
    ...
    */
    E6_Destruction: prefixer('E6_Destruction'),

    /**
    * **[was death of](http://www.cidoc-crm.org/cidoc-crm/P100_was_death_of)** (property)
    * 
    ...
    */
    P100_was_death_of: prefixer('P100_was_death_of'),

    /**
    * **[Thing](http://www.cidoc-crm.org/cidoc-crm/E70_Thing)** (class)
    * 
    ...
    */
    E70_Thing: prefixer('E70_Thing'),

    /**
    * **[took out of existence](http://www.cidoc-crm.org/cidoc-crm/P93_took_out_of_existence)** (property)
    * 
    ...
    */
    P93_took_out_of_existence: prefixer('P93_took_out_of_existence'),

    /**
    * **[Group](http://www.cidoc-crm.org/cidoc-crm/E74_Group)** (class)
    * 
    ...
    */
    E74_Group: prefixer('E74_Group'),

    /**
    * **[Curated Holding](http://www.cidoc-crm.org/cidoc-crm/E78_Curated_Holding)** (class)
    * 
    ...
    */
    E78_Curated_Holding: prefixer('E78_Curated_Holding'),

    /**
    * **[Part Addition](http://www.cidoc-crm.org/cidoc-crm/E79_Part_Addition)** (class)
    * 
    ...
    */
    E79_Part_Addition: prefixer('E79_Part_Addition'),

    /**
    * **[had as general use](http://www.cidoc-crm.org/cidoc-crm/P101_had_as_general_use)** (property)
    * 
    ...
    */
    P101_had_as_general_use: prefixer('P101_had_as_general_use'),

    /**
    * **[Part Removal](http://www.cidoc-crm.org/cidoc-crm/E80_Part_Removal)** (class)
    * 
    ...
    */
    E80_Part_Removal: prefixer('E80_Part_Removal'),

    /**
    * **[Transformation](http://www.cidoc-crm.org/cidoc-crm/E81_Transformation)** (class)
    * 
    ...
    */
    E81_Transformation: prefixer('E81_Transformation'),

    /**
    * **[has title](http://www.cidoc-crm.org/cidoc-crm/P102_has_title)** (property)
    * 
    ...
    */
    P102_has_title: prefixer('P102_has_title'),

    /**
    * **[Type Creation](http://www.cidoc-crm.org/cidoc-crm/E83_Type_Creation)** (class)
    * 
    ...
    */
    E83_Type_Creation: prefixer('E83_Type_Creation'),

    /**
    * **[is identified by](http://www.cidoc-crm.org/cidoc-crm/P1_is_identified_by)** (property)
    * 
    ...
    */
    P1_is_identified_by: prefixer('P1_is_identified_by'),

    /**
    * **[Joining](http://www.cidoc-crm.org/cidoc-crm/E85_Joining)** (class)
    * 
    ...
    */
    E85_Joining: prefixer('E85_Joining'),

    /**
    * **[Leaving](http://www.cidoc-crm.org/cidoc-crm/E86_Leaving)** (class)
    * 
    ...
    */
    E86_Leaving: prefixer('E86_Leaving'),

    /**
    * **[Curation Activity](http://www.cidoc-crm.org/cidoc-crm/E87_Curation_Activity)** (class)
    * 
    ...
    */
    E87_Curation_Activity: prefixer('E87_Curation_Activity'),

    /**
    * **[was intended for](http://www.cidoc-crm.org/cidoc-crm/P103_was_intended_for)** (property)
    * 
    ...
    */
    P103_was_intended_for: prefixer('P103_was_intended_for'),

    /**
    * **[Acquisition](http://www.cidoc-crm.org/cidoc-crm/E8_Acquisition)** (class)
    * 
    ...
    */
    E8_Acquisition: prefixer('E8_Acquisition'),

    /**
    * **[Presence](http://www.cidoc-crm.org/cidoc-crm/E93_Presence)** (class)
    * 
    ...
    */
    E93_Presence: prefixer('E93_Presence'),

    /**
    * **[is subject to](http://www.cidoc-crm.org/cidoc-crm/P104_is_subject_to)** (property)
    * 
    ...
    */
    P104_is_subject_to: prefixer('P104_is_subject_to'),

    /**
    * **[Purchase](http://www.cidoc-crm.org/cidoc-crm/E96_Purchase)** (class)
    * 
    ...
    */
    E96_Purchase: prefixer('E96_Purchase'),

    /**
    * **[Monetary Amount](http://www.cidoc-crm.org/cidoc-crm/E97_Monetary_Amount)** (class)
    * 
    ...
    */
    E97_Monetary_Amount: prefixer('E97_Monetary_Amount'),

    /**
    * **[right held by](http://www.cidoc-crm.org/cidoc-crm/P105_right_held_by)** (property)
    * 
    ...
    */
    P105_right_held_by: prefixer('P105_right_held_by'),

    /**
    * **[Currency](http://www.cidoc-crm.org/cidoc-crm/E98_Currency)** (class)
    * 
    ...
    */
    E98_Currency: prefixer('E98_Currency'),

    /**
    * **[Product Type](http://www.cidoc-crm.org/cidoc-crm/E99_Product_Type)** (class)
    * 
    ...
    */
    E99_Product_Type: prefixer('E99_Product_Type'),

    /**
    * **[is composed of](http://www.cidoc-crm.org/cidoc-crm/P106_is_composed_of)** (property)
    * 
    ...
    */
    P106_is_composed_of: prefixer('P106_is_composed_of'),

    /**
    * **[Move](http://www.cidoc-crm.org/cidoc-crm/E9_Move)** (class)
    * 
    ...
    */
    E9_Move: prefixer('E9_Move'),

    /**
    * **[has current or former member](http://www.cidoc-crm.org/cidoc-crm/P107_has_current_or_former_member)** (property)
    * 
    ...
    */
    P107_has_current_or_former_member: prefixer('P107_has_current_or_former_member'),

    /**
    * **[has produced](http://www.cidoc-crm.org/cidoc-crm/P108_has_produced)** (property)
    * 
    ...
    */
    P108_has_produced: prefixer('P108_has_produced'),

    /**
    * **[has modified](http://www.cidoc-crm.org/cidoc-crm/P31_has_modified)** (property)
    * 
    * This property identifies the instance of E18 Physical Thing modified in an instance of E11 Modification.
    */
    P31_has_modified: prefixer('P31_has_modified'),

    /**
    * **[brought into existence](http://www.cidoc-crm.org/cidoc-crm/P92_brought_into_existence)** (property)
    * 
    ...
    */
    P92_brought_into_existence: prefixer('P92_brought_into_existence'),

    /**
    * **[has current or former curator](http://www.cidoc-crm.org/cidoc-crm/P109_has_current_or_former_curator)** (property)
    * 
    ...
    */
    P109_has_current_or_former_curator: prefixer('P109_has_current_or_former_curator'),

    /**
    * **[has former or current keeper](http://www.cidoc-crm.org/cidoc-crm/P49_has_former_or_current_keeper)** (property)
    * 
    ...
    */
    P49_has_former_or_current_keeper: prefixer('P49_has_former_or_current_keeper'),

    /**
    * **[falls within](http://www.cidoc-crm.org/cidoc-crm/P10_falls_within)** (property)
    * 
    ...
    */
    P10_falls_within: prefixer('P10_falls_within'),

    /**
    * **[spatiotemporally overlaps with](http://www.cidoc-crm.org/cidoc-crm/P132_spatiotemporally_overlaps_with)** (property)
    * 
    ...
    */
    P132_spatiotemporally_overlaps_with: prefixer('P132_spatiotemporally_overlaps_with'),

    /**
    * **[augmented](http://www.cidoc-crm.org/cidoc-crm/P110_augmented)** (property)
    * 
    ...
    */
    P110_augmented: prefixer('P110_augmented'),

    /**
    * **[added](http://www.cidoc-crm.org/cidoc-crm/P111_added)** (property)
    * 
    ...
    */
    P111_added: prefixer('P111_added'),

    /**
    * **[used specific object](http://www.cidoc-crm.org/cidoc-crm/P16_used_specific_object)** (property)
    * 
    ...
    */
    P16_used_specific_object: prefixer('P16_used_specific_object'),

    /**
    * **[diminished](http://www.cidoc-crm.org/cidoc-crm/P112_diminished)** (property)
    * 
    ...
    */
    P112_diminished: prefixer('P112_diminished'),

    /**
    * **[removed](http://www.cidoc-crm.org/cidoc-crm/P113_removed)** (property)
    * 
    ...
    */
    P113_removed: prefixer('P113_removed'),

    /**
    * **[occurred in the presence of](http://www.cidoc-crm.org/cidoc-crm/P12_occurred_in_the_presence_of)** (property)
    * 
    ...
    */
    P12_occurred_in_the_presence_of: prefixer('P12_occurred_in_the_presence_of'),

    /**
    * **[had participant](http://www.cidoc-crm.org/cidoc-crm/P11_had_participant)** (property)
    * 
    ...
    */
    P11_had_participant: prefixer('P11_had_participant'),

    /**
    * **[overlaps with](http://www.cidoc-crm.org/cidoc-crm/P121_overlaps_with)** (property)
    * 
    ...
    */
    P121_overlaps_with: prefixer('P121_overlaps_with'),

    /**
    * **[borders with](http://www.cidoc-crm.org/cidoc-crm/P122_borders_with)** (property)
    * 
    ...
    */
    P122_borders_with: prefixer('P122_borders_with'),

    /**
    * **[resulted in](http://www.cidoc-crm.org/cidoc-crm/P123_resulted_in)** (property)
    * 
    ...
    */
    P123_resulted_in: prefixer('P123_resulted_in'),

    /**
    * **[transformed](http://www.cidoc-crm.org/cidoc-crm/P124_transformed)** (property)
    * 
    ...
    */
    P124_transformed: prefixer('P124_transformed'),

    /**
    * **[used object of type](http://www.cidoc-crm.org/cidoc-crm/P125_used_object_of_type)** (property)
    * 
    ...
    */
    P125_used_object_of_type: prefixer('P125_used_object_of_type'),

    /**
    * **[employed](http://www.cidoc-crm.org/cidoc-crm/P126_employed)** (property)
    * 
    ...
    */
    P126_employed: prefixer('P126_employed'),

    /**
    * **[has broader term](http://www.cidoc-crm.org/cidoc-crm/P127_has_broader_term)** (property)
    * 
    ...
    */
    P127_has_broader_term: prefixer('P127_has_broader_term'),

    /**
    * **[carries](http://www.cidoc-crm.org/cidoc-crm/P128_carries)** (property)
    * 
    ...
    */
    P128_carries: prefixer('P128_carries'),

    /**
    * **[shows features of](http://www.cidoc-crm.org/cidoc-crm/P130_shows_features_of)** (property)
    * 
    ...
    */
    P130_shows_features_of: prefixer('P130_shows_features_of'),

    /**
    * **[is about](http://www.cidoc-crm.org/cidoc-crm/P129_is_about)** (property)
    * 
    ...
    */
    P129_is_about: prefixer('P129_is_about'),

    /**
    * **[refers to](http://www.cidoc-crm.org/cidoc-crm/P67_refers_to)** (property)
    * 
    ...
    */
    P67_refers_to: prefixer('P67_refers_to'),

    /**
    * **[is spatiotemporally separated from](http://www.cidoc-crm.org/cidoc-crm/P133_is_spatiotemporally_separated_from)** (property)
    * 
    ...
    */
    P133_is_spatiotemporally_separated_from: prefixer('P133_is_spatiotemporally_separated_from'),

    /**
    * **[continued](http://www.cidoc-crm.org/cidoc-crm/P134_continued)** (property)
    * 
    ...
    */
    P134_continued: prefixer('P134_continued'),

    /**
    * **[was influenced by](http://www.cidoc-crm.org/cidoc-crm/P15_was_influenced_by)** (property)
    * 
    ...
    */
    P15_was_influenced_by: prefixer('P15_was_influenced_by'),

    /**
    * **[starts before the start of](http://www.cidoc-crm.org/cidoc-crm/P176_starts_before_the_start_of)** (property)
    * 
    ...
    */
    P176_starts_before_the_start_of: prefixer('P176_starts_before_the_start_of'),

    /**
    * **[created type](http://www.cidoc-crm.org/cidoc-crm/P135_created_type)** (property)
    * 
    * This property identifies the instance of E55 Type, which is created in an instance of E83 Type Creation activity.
    */
    P135_created_type: prefixer('P135_created_type'),

    /**
    * **[has created](http://www.cidoc-crm.org/cidoc-crm/P94_has_created)** (property)
    * 
    ...
    */
    P94_has_created: prefixer('P94_has_created'),

    /**
    * **[was based on](http://www.cidoc-crm.org/cidoc-crm/P136_was_based_on)** (property)
    * 
    ...
    */
    P136_was_based_on: prefixer('P136_was_based_on'),

    /**
    * **[exemplifies](http://www.cidoc-crm.org/cidoc-crm/P137_exemplifies)** (property)
    * 
    ...
    */
    P137_exemplifies: prefixer('P137_exemplifies'),

    /**
    * **[has type](http://www.cidoc-crm.org/cidoc-crm/P2_has_type)** (property)
    * 
    ...
    */
    P2_has_type: prefixer('P2_has_type'),

    /**
    * **[represents](http://www.cidoc-crm.org/cidoc-crm/P138_represents)** (property)
    * 
    ...
    */
    P138_represents: prefixer('P138_represents'),

    /**
    * **[has alternative form](http://www.cidoc-crm.org/cidoc-crm/P139_has_alternative_form)** (property)
    * 
    ...
    */
    P139_has_alternative_form: prefixer('P139_has_alternative_form'),

    /**
    * **[destroyed](http://www.cidoc-crm.org/cidoc-crm/P13_destroyed)** (property)
    * 
    ...
    */
    P13_destroyed: prefixer('P13_destroyed'),

    /**
    * **[assigned attribute to](http://www.cidoc-crm.org/cidoc-crm/P140_assigned_attribute_to)** (property)
    * 
    ...
    */
    P140_assigned_attribute_to: prefixer('P140_assigned_attribute_to'),

    /**
    * **[assigned](http://www.cidoc-crm.org/cidoc-crm/P141_assigned)** (property)
    * 
    ...
    * The kind of attribution made should be documented using P177 assigned property of type (is type of property assigned).
    */
    P141_assigned: prefixer('P141_assigned'),

    /**
    * **[used constituent](http://www.cidoc-crm.org/cidoc-crm/P142_used_constituent)** (property)
    * 
    ...
    */
    P142_used_constituent: prefixer('P142_used_constituent'),

    /**
    * **[joined](http://www.cidoc-crm.org/cidoc-crm/P143_joined)** (property)
    * 
    ...
    */
    P143_joined: prefixer('P143_joined'),

    /**
    * **[joined with](http://www.cidoc-crm.org/cidoc-crm/P144_joined_with)** (property)
    * 
    ...
    */
    P144_joined_with: prefixer('P144_joined_with'),

    /**
    * **[separated](http://www.cidoc-crm.org/cidoc-crm/P145_separated)** (property)
    * 
    ...
    */
    P145_separated: prefixer('P145_separated'),

    /**
    * **[separated from](http://www.cidoc-crm.org/cidoc-crm/P146_separated_from)** (property)
    * 
    ...
    */
    P146_separated_from: prefixer('P146_separated_from'),

    /**
    * **[curated](http://www.cidoc-crm.org/cidoc-crm/P147_curated)** (property)
    * 
    ...
    */
    P147_curated: prefixer('P147_curated'),

    /**
    * **[has component](http://www.cidoc-crm.org/cidoc-crm/P148_has_component)** (property)
    * 
    ...
    * This property is transitive. This property is asymmetric.
    */
    P148_has_component: prefixer('P148_has_component'),

    /**
    * **[carried out by](http://www.cidoc-crm.org/cidoc-crm/P14_carried_out_by)** (property)
    * 
    ...
    */
    P14_carried_out_by: prefixer('P14_carried_out_by'),

    /**
    * **[defines typical parts of](http://www.cidoc-crm.org/cidoc-crm/P150_defines_typical_parts_of)** (property)
    * 
    ...
    * This property is not transitive. This property is asymmetric.
    */
    P150_defines_typical_parts_of: prefixer('P150_defines_typical_parts_of'),

    /**
    * **[was formed from](http://www.cidoc-crm.org/cidoc-crm/P151_was_formed_from)** (property)
    * 
    ...
    */
    P151_was_formed_from: prefixer('P151_was_formed_from'),

    /**
    * **[has parent](http://www.cidoc-crm.org/cidoc-crm/P152_has_parent)** (property)
    * 
    ...
    * This property is not transitive. This property is irreflexive.
    */
    P152_has_parent: prefixer('P152_has_parent'),

    /**
    * **[occupies](http://www.cidoc-crm.org/cidoc-crm/P156_occupies)** (property)
    * 
    ...
    */
    P156_occupies: prefixer('P156_occupies'),

    /**
    * **[has former or current location](http://www.cidoc-crm.org/cidoc-crm/P53_has_former_or_current_location)** (property)
    * 
    ...
    */
    P53_has_former_or_current_location: prefixer('P53_has_former_or_current_location'),

    /**
    * **[is at rest relative to](http://www.cidoc-crm.org/cidoc-crm/P157_is_at_rest_relative_to)** (property)
    * 
    ...
    */
    P157_is_at_rest_relative_to: prefixer('P157_is_at_rest_relative_to'),

    /**
    * **[has temporal projection](http://www.cidoc-crm.org/cidoc-crm/P160_has_temporal_projection)** (property)
    * 
    ...
    */
    P160_has_temporal_projection: prefixer('P160_has_temporal_projection'),

    /**
    * **[has spatial projection](http://www.cidoc-crm.org/cidoc-crm/P161_has_spatial_projection)** (property)
    * 
    ...
    */
    P161_has_spatial_projection: prefixer('P161_has_spatial_projection'),

    /**
    * **[is temporally specified by](http://www.cidoc-crm.org/cidoc-crm/P164_is_temporally_specified_by)** (property)
    * 
    ...
    */
    P164_is_temporally_specified_by: prefixer('P164_is_temporally_specified_by'),

    /**
    * **[incorporates](http://www.cidoc-crm.org/cidoc-crm/P165_incorporates)** (property)
    * 
    ...
    */
    P165_incorporates: prefixer('P165_incorporates'),

    /**
    * **[was a presence of](http://www.cidoc-crm.org/cidoc-crm/P166_was_a_presence_of)** (property)
    * 
    ...
    */
    P166_was_a_presence_of: prefixer('P166_was_a_presence_of'),

    /**
    * **[was within](http://www.cidoc-crm.org/cidoc-crm/P167_was_within)** (property)
    * 
    ...
    */
    P167_was_within: prefixer('P167_was_within'),

    /**
    * **[place is defined by](http://www.cidoc-crm.org/cidoc-crm/P168_place_is_defined_by)** (property)
    * 
    ...
    */
    P168_place_is_defined_by: prefixer('P168_place_is_defined_by'),

    /**
    * **[spacetime volume is defined by](http://www.cidoc-crm.org/cidoc-crm/P169i_spacetime_volume_is_defined_by)** (property)
    * 
    ...
    */
    P169i_spacetime_volume_is_defined_by: prefixer('P169i_spacetime_volume_is_defined_by'),

    /**
    * **[time is defined by](http://www.cidoc-crm.org/cidoc-crm/P170i_time_is_defined_by)** (property)
    * 
    ...
    */
    P170i_time_is_defined_by: prefixer('P170i_time_is_defined_by'),

    /**
    * **[at some place within](http://www.cidoc-crm.org/cidoc-crm/P171_at_some_place_within)** (property)
    * 
    ...
    */
    P171_at_some_place_within: prefixer('P171_at_some_place_within'),

    /**
    * **[contains](http://www.cidoc-crm.org/cidoc-crm/P172_contains)** (property)
    * 
    ...
    */
    P172_contains: prefixer('P172_contains'),

    /**
    * **[starts before or with the end of](http://www.cidoc-crm.org/cidoc-crm/P173_starts_before_or_with_the_end_of)** (property)
    * 
    ...
    */
    P173_starts_before_or_with_the_end_of: prefixer('P173_starts_before_or_with_the_end_of'),

    /**
    * **[starts before the end of](http://www.cidoc-crm.org/cidoc-crm/P174_starts_before_the_end_of)** (property)
    * 
    ...
    */
    P174_starts_before_the_end_of: prefixer('P174_starts_before_the_end_of'),

    /**
    * **[starts before or with the start of](http://www.cidoc-crm.org/cidoc-crm/P175_starts_before_or_with_the_start_of)** (property)
    * 
    ...
    */
    P175_starts_before_or_with_the_start_of: prefixer('P175_starts_before_or_with_the_start_of'),

    /**
    * **[assigned property of type](http://www.cidoc-crm.org/cidoc-crm/P177_assigned_property_of_type)** (property)
    * 
    ...
    */
    P177_assigned_property_of_type: prefixer('P177_assigned_property_of_type'),

    /**
    * **[had sales price](http://www.cidoc-crm.org/cidoc-crm/P179_had_sales_price)** (property)
    * 
    ...
    */
    P179_had_sales_price: prefixer('P179_had_sales_price'),

    /**
    * **[was motivated by](http://www.cidoc-crm.org/cidoc-crm/P17_was_motivated_by)** (property)
    * 
    ...
    */
    P17_was_motivated_by: prefixer('P17_was_motivated_by'),

    /**
    * **[has currency](http://www.cidoc-crm.org/cidoc-crm/P180_has_currency)** (property)
    * 
    ...
    */
    P180_has_currency: prefixer('P180_has_currency'),

    /**
    * **[has unit](http://www.cidoc-crm.org/cidoc-crm/P91_has_unit)** (property)
    * 
    * This property shows the type of unit an instance of E54 Dimension was expressed in.
    */
    P91_has_unit: prefixer('P91_has_unit'),

    /**
    * **[ends before or with the start of](http://www.cidoc-crm.org/cidoc-crm/P182_ends_before_or_with_the_start_of)** (property)
    * 
    ...
    */
    P182_ends_before_or_with_the_start_of: prefixer('P182_ends_before_or_with_the_start_of'),

    /**
    * **[ends before the end of](http://www.cidoc-crm.org/cidoc-crm/P185_ends_before_the_end_of)** (property)
    * 
    ...
    */
    P185_ends_before_the_end_of: prefixer('P185_ends_before_the_end_of'),

    /**
    * **[ends before the start of](http://www.cidoc-crm.org/cidoc-crm/P183_ends_before_the_start_of)** (property)
    * 
    ...
    */
    P183_ends_before_the_start_of: prefixer('P183_ends_before_the_start_of'),

    /**
    * **[ends before or with the end of](http://www.cidoc-crm.org/cidoc-crm/P184_ends_before_or_with_the_end_of)** (property)
    * 
    ...
    */
    P184_ends_before_or_with_the_end_of: prefixer('P184_ends_before_or_with_the_end_of'),

    /**
    * **[produced thing of product type](http://www.cidoc-crm.org/cidoc-crm/P186_produced_thing_of_product_type)** (property)
    * 
    ...
    */
    P186_produced_thing_of_product_type: prefixer('P186_produced_thing_of_product_type'),

    /**
    * **[has production plan](http://www.cidoc-crm.org/cidoc-crm/P187_has_production_plan)** (property)
    * 
    ...
    */
    P187_has_production_plan: prefixer('P187_has_production_plan'),

    /**
    * **[requires production tool](http://www.cidoc-crm.org/cidoc-crm/P188_requires_production_tool)** (property)
    * 
    ...
    */
    P188_requires_production_tool: prefixer('P188_requires_production_tool'),

    /**
    * **[approximates](http://www.cidoc-crm.org/cidoc-crm/P189_approximates)** (property)
    * 
    ...
    */
    P189_approximates: prefixer('P189_approximates'),

    /**
    * **[has symbolic content](http://www.cidoc-crm.org/cidoc-crm/P190_has_symbolic_content)** (property)
    * 
    ...
    */
    P190_has_symbolic_content: prefixer('P190_has_symbolic_content'),

    /**
    * **[has note](http://www.cidoc-crm.org/cidoc-crm/P3_has_note)** (property)
    * 
    ...
    */
    P3_has_note: prefixer('P3_has_note'),

    /**
    * **[had duration](http://www.cidoc-crm.org/cidoc-crm/P191_had_duration)** (property)
    * 
    ...
    */
    P191_had_duration: prefixer('P191_had_duration'),

    /**
    * **[was a presence of](http://www.cidoc-crm.org/cidoc-crm/P195_was_a_presence_of)** (property)
    * 
    ...
    */
    P195_was_a_presence_of: prefixer('P195_was_a_presence_of'),

    /**
    * **[defines](http://www.cidoc-crm.org/cidoc-crm/P196_defines)** (property)
    * 
    ...
    */
    P196_defines: prefixer('P196_defines'),

    /**
    * **[covered parts of](http://www.cidoc-crm.org/cidoc-crm/P197_covered_parts_of)** (property)
    * 
    ...
    */
    P197_covered_parts_of: prefixer('P197_covered_parts_of'),

    /**
    * **[holds or supports](http://www.cidoc-crm.org/cidoc-crm/P198_holds_or_supports)** (property)
    * 
    ...
    * This property is transitive. This property is asymmetric.
    */
    P198_holds_or_supports: prefixer('P198_holds_or_supports'),

    /**
    * **[was intended use of](http://www.cidoc-crm.org/cidoc-crm/P19_was_intended_use_of)** (property)
    * 
    ...
    */
    P19_was_intended_use_of: prefixer('P19_was_intended_use_of'),

    /**
    * **[had specific purpose](http://www.cidoc-crm.org/cidoc-crm/P20_had_specific_purpose)** (property)
    * 
    ...
    */
    P20_had_specific_purpose: prefixer('P20_had_specific_purpose'),

    /**
    * **[had general purpose](http://www.cidoc-crm.org/cidoc-crm/P21_had_general_purpose)** (property)
    * 
    ...
    */
    P21_had_general_purpose: prefixer('P21_had_general_purpose'),

    /**
    * **[transferred title to](http://www.cidoc-crm.org/cidoc-crm/P22_transferred_title_to)** (property)
    * 
    ...
    */
    P22_transferred_title_to: prefixer('P22_transferred_title_to'),

    /**
    * **[transferred title from](http://www.cidoc-crm.org/cidoc-crm/P23_transferred_title_from)** (property)
    * 
    ...
    */
    P23_transferred_title_from: prefixer('P23_transferred_title_from'),

    /**
    * **[transferred title of](http://www.cidoc-crm.org/cidoc-crm/P24_transferred_title_of)** (property)
    * 
    ...
    */
    P24_transferred_title_of: prefixer('P24_transferred_title_of'),

    /**
    * **[moved](http://www.cidoc-crm.org/cidoc-crm/P25_moved)** (property)
    * 
    ...
    */
    P25_moved: prefixer('P25_moved'),

    /**
    * **[moved to](http://www.cidoc-crm.org/cidoc-crm/P26_moved_to)** (property)
    * 
    ...
    */
    P26_moved_to: prefixer('P26_moved_to'),

    /**
    * **[moved from](http://www.cidoc-crm.org/cidoc-crm/P27_moved_from)** (property)
    * 
    ...
    */
    P27_moved_from: prefixer('P27_moved_from'),

    /**
    * **[custody surrendered by](http://www.cidoc-crm.org/cidoc-crm/P28_custody_surrendered_by)** (property)
    * 
    ...
    */
    P28_custody_surrendered_by: prefixer('P28_custody_surrendered_by'),

    /**
    * **[custody received by](http://www.cidoc-crm.org/cidoc-crm/P29_custody_received_by)** (property)
    * 
    ...
    * In reality, custody is either transferred to someone or from someone, or both.
    */
    P29_custody_received_by: prefixer('P29_custody_received_by'),

    /**
    * **[transferred custody of](http://www.cidoc-crm.org/cidoc-crm/P30_transferred_custody_of)** (property)
    * 
    ...
    */
    P30_transferred_custody_of: prefixer('P30_transferred_custody_of'),

    /**
    * **[used general technique](http://www.cidoc-crm.org/cidoc-crm/P32_used_general_technique)** (property)
    * 
    ...
    */
    P32_used_general_technique: prefixer('P32_used_general_technique'),

    /**
    * **[used specific technique](http://www.cidoc-crm.org/cidoc-crm/P33_used_specific_technique)** (property)
    * 
    ...
    */
    P33_used_specific_technique: prefixer('P33_used_specific_technique'),

    /**
    * **[concerned](http://www.cidoc-crm.org/cidoc-crm/P34_concerned)** (property)
    * 
    ...
    */
    P34_concerned: prefixer('P34_concerned'),

    /**
    * **[has identified](http://www.cidoc-crm.org/cidoc-crm/P35_has_identified)** (property)
    * 
    ...
    */
    P35_has_identified: prefixer('P35_has_identified'),

    /**
    * **[assigned](http://www.cidoc-crm.org/cidoc-crm/P37_assigned)** (property)
    * 
    ...
    */
    P37_assigned: prefixer('P37_assigned'),

    /**
    * **[deassigned](http://www.cidoc-crm.org/cidoc-crm/P38_deassigned)** (property)
    * 
    ...
    */
    P38_deassigned: prefixer('P38_deassigned'),

    /**
    * **[measured](http://www.cidoc-crm.org/cidoc-crm/P39_measured)** (property)
    * 
    ...
    */
    P39_measured: prefixer('P39_measured'),

    /**
    * **[observed dimension](http://www.cidoc-crm.org/cidoc-crm/P40_observed_dimension)** (property)
    * 
    ...
    */
    P40_observed_dimension: prefixer('P40_observed_dimension'),

    /**
    * **[classified](http://www.cidoc-crm.org/cidoc-crm/P41_classified)** (property)
    * 
    ...
    */
    P41_classified: prefixer('P41_classified'),

    /**
    * **[assigned](http://www.cidoc-crm.org/cidoc-crm/P42_assigned)** (property)
    * 
    ...
    */
    P42_assigned: prefixer('P42_assigned'),

    /**
    * **[has dimension](http://www.cidoc-crm.org/cidoc-crm/P43_has_dimension)** (property)
    * 
    ...
    */
    P43_has_dimension: prefixer('P43_has_dimension'),

    /**
    * **[has condition](http://www.cidoc-crm.org/cidoc-crm/P44_has_condition)** (property)
    * 
    ...
    */
    P44_has_condition: prefixer('P44_has_condition'),

    /**
    * **[consists of](http://www.cidoc-crm.org/cidoc-crm/P45_consists_of)** (property)
    * 
    ...
    */
    P45_consists_of: prefixer('P45_consists_of'),

    /**
    * **[is composed of](http://www.cidoc-crm.org/cidoc-crm/P46_is_composed_of)** (property)
    * 
    ...
    */
    P46_is_composed_of: prefixer('P46_is_composed_of'),

    /**
    * **[has preferred identifier](http://www.cidoc-crm.org/cidoc-crm/P48_has_preferred_identifier)** (property)
    * 
    ...
    */
    P48_has_preferred_identifier: prefixer('P48_has_preferred_identifier'),

    /**
    * **[has time-span](http://www.cidoc-crm.org/cidoc-crm/P4_has_time-span)** (property)
    * 
    ...
    */
    'P4_has_time-span': prefixer('P4_has_time-span'),

    /**
    * **[has current keeper](http://www.cidoc-crm.org/cidoc-crm/P50_has_current_keeper)** (property)
    * 
    ...
    */
    P50_has_current_keeper: prefixer('P50_has_current_keeper'),

    /**
    * **[has former or current owner](http://www.cidoc-crm.org/cidoc-crm/P51_has_former_or_current_owner)** (property)
    * 
    ...
    */
    P51_has_former_or_current_owner: prefixer('P51_has_former_or_current_owner'),

    /**
    * **[has current owner](http://www.cidoc-crm.org/cidoc-crm/P52_has_current_owner)** (property)
    * 
    ...
    */
    P52_has_current_owner: prefixer('P52_has_current_owner'),

    /**
    * **[has current permanent location](http://www.cidoc-crm.org/cidoc-crm/P54_has_current_permanent_location)** (property)
    * 
    ...
    */
    P54_has_current_permanent_location: prefixer('P54_has_current_permanent_location'),

    /**
    * **[has current location](http://www.cidoc-crm.org/cidoc-crm/P55_has_current_location)** (property)
    * 
    ...
    */
    P55_has_current_location: prefixer('P55_has_current_location'),

    /**
    * **[bears feature](http://www.cidoc-crm.org/cidoc-crm/P56_bears_feature)** (property)
    * 
    ...
    */
    P56_bears_feature: prefixer('P56_bears_feature'),

    /**
    * **[has number of parts](http://www.cidoc-crm.org/cidoc-crm/P57_has_number_of_parts)** (property)
    * 
    ...
    */
    P57_has_number_of_parts: prefixer('P57_has_number_of_parts'),

    /**
    * **[has section](http://www.cidoc-crm.org/cidoc-crm/P59_has_section)** (property)
    * 
    ...
    */
    P59_has_section: prefixer('P59_has_section'),

    /**
    * **[consists of](http://www.cidoc-crm.org/cidoc-crm/P5_consists_of)** (property)
    * 
    ...
    * This property is transitive and asymmetric.
    */
    P5_consists_of: prefixer('P5_consists_of'),

    /**
    * **[depicts](http://www.cidoc-crm.org/cidoc-crm/P62_depicts)** (property)
    * 
    ...
    */
    P62_depicts: prefixer('P62_depicts'),

    /**
    * **[shows visual item](http://www.cidoc-crm.org/cidoc-crm/P65_shows_visual_item)** (property)
    * 
    ...
    */
    P65_shows_visual_item: prefixer('P65_shows_visual_item'),

    /**
    * **[foresees use of](http://www.cidoc-crm.org/cidoc-crm/P68_foresees_use_of)** (property)
    * 
    ...
    */
    P68_foresees_use_of: prefixer('P68_foresees_use_of'),

    /**
    * **[has association with](http://www.cidoc-crm.org/cidoc-crm/P69_has_association_with)** (property)
    * 
    ...
    */
    P69_has_association_with: prefixer('P69_has_association_with'),

    /**
    * **[documents](http://www.cidoc-crm.org/cidoc-crm/P70_documents)** (property)
    * 
    ...
    */
    P70_documents: prefixer('P70_documents'),

    /**
    * **[lists](http://www.cidoc-crm.org/cidoc-crm/P71_lists)** (property)
    * 
    ...
    */
    P71_lists: prefixer('P71_lists'),

    /**
    * **[has language](http://www.cidoc-crm.org/cidoc-crm/P72_has_language)** (property)
    * 
    ...
    */
    P72_has_language: prefixer('P72_has_language'),

    /**
    * **[has translation](http://www.cidoc-crm.org/cidoc-crm/P73_has_translation)** (property)
    * 
    ...
    * This property is asymmetric.
    */
    P73_has_translation: prefixer('P73_has_translation'),

    /**
    * **[has current or former residence](http://www.cidoc-crm.org/cidoc-crm/P74_has_current_or_former_residence)** (property)
    * 
    ...
    */
    P74_has_current_or_former_residence: prefixer('P74_has_current_or_former_residence'),

    /**
    * **[possesses](http://www.cidoc-crm.org/cidoc-crm/P75_possesses)** (property)
    * 
    ...
    */
    P75_possesses: prefixer('P75_possesses'),

    /**
    * **[has contact point](http://www.cidoc-crm.org/cidoc-crm/P76_has_contact_point)** (property)
    * 
    ...
    */
    P76_has_contact_point: prefixer('P76_has_contact_point'),

    /**
    * **[beginning is qualified by](http://www.cidoc-crm.org/cidoc-crm/P79_beginning_is_qualified_by)** (property)
    * 
    ...
    */
    P79_beginning_is_qualified_by: prefixer('P79_beginning_is_qualified_by'),

    /**
    * **[took place at](http://www.cidoc-crm.org/cidoc-crm/P7_took_place_at)** (property)
    * 
    ...
    */
    P7_took_place_at: prefixer('P7_took_place_at'),

    /**
    * **[end is qualified by](http://www.cidoc-crm.org/cidoc-crm/P80_end_is_qualified_by)** (property)
    * 
    ...
    */
    P80_end_is_qualified_by: prefixer('P80_end_is_qualified_by'),

    /**
    * **[ongoing throughout](http://www.cidoc-crm.org/cidoc-crm/P81_ongoing_throughout)** (property)
    * 
    ...
    */
    P81_ongoing_throughout: prefixer('P81_ongoing_throughout'),

    /**
    * **[at some time within](http://www.cidoc-crm.org/cidoc-crm/P82_at_some_time_within)** (property)
    * 
    ...
    */
    P82_at_some_time_within: prefixer('P82_at_some_time_within'),

    /**
    * **[falls within](http://www.cidoc-crm.org/cidoc-crm/P86_falls_within)** (property)
    * 
    ...
    */
    P86_falls_within: prefixer('P86_falls_within'),

    /**
    * **[falls within](http://www.cidoc-crm.org/cidoc-crm/P89_falls_within)** (property)
    * 
    ...
    * This property is transitive and reflexive.
    */
    P89_falls_within: prefixer('P89_falls_within'),

    /**
    * **[took place on or within](http://www.cidoc-crm.org/cidoc-crm/P8_took_place_on_or_within)** (property)
    * 
    ...
    */
    P8_took_place_on_or_within: prefixer('P8_took_place_on_or_within'),

    /**
    * **[has value](http://www.cidoc-crm.org/cidoc-crm/P90_has_value)** (property)
    * 
    * This property allows an instance of E54 Dimension to be approximated by an instance of E60 Number primitive.
    */
    P90_has_value: prefixer('P90_has_value'),

    /**
    * **[has formed](http://www.cidoc-crm.org/cidoc-crm/P95_has_formed)** (property)
    * 
    * This property associates the instance of E66 Formation with the instance of E74 Group that it founded.
    */
    P95_has_formed: prefixer('P95_has_formed'),

    /**
    * **[by mother](http://www.cidoc-crm.org/cidoc-crm/P96_by_mother)** (property)
    * 
    ...
    */
    P96_by_mother: prefixer('P96_by_mother'),

    /**
    * **[from father](http://www.cidoc-crm.org/cidoc-crm/P97_from_father)** (property)
    * 
    ...
    */
    P97_from_father: prefixer('P97_from_father'),

    /**
    * **[brought into life](http://www.cidoc-crm.org/cidoc-crm/P98_brought_into_life)** (property)
    * 
    ...
    */
    P98_brought_into_life: prefixer('P98_brought_into_life'),

    /**
    * **[dissolved](http://www.cidoc-crm.org/cidoc-crm/P99_dissolved)** (property)
    * 
    * This property associates the instance of E68 Dissolution with the instance of E74 Group that it disbanded.
    */
    P99_dissolved: prefixer('P99_dissolved'),

    /**
    * **[consists of](http://www.cidoc-crm.org/cidoc-crm/P9_consists_of)** (property)
    * 
    ...
    * This property is transitive and asymmetric.
    */
    P9_consists_of: prefixer('P9_consists_of'),
