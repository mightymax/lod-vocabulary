...
const prefixer = $prefixer('http://www.opengis.net/ont/sf#');
...
const sf = {
  /**
    * **[Curve](http://www.opengis.net/ont/sf#Curve)** (class)
    * 
    * 
    ...
    * 
    */
    Curve: prefixer('Curve'),

    /**
    * **[Geometry](http://www.opengis.net/ont/sf#Geometry)** (class)
    * 
    * 
    ...
    */
    ...
    /**
    * **[Geometry Collection](http://www.opengis.net/ont/sf#GeometryCollection)** (class)
    * 
    * 
    ...
    */
    ...
    /**
    * **[Line](http://www.opengis.net/ont/sf#Line)** (class)
    * 
    * 
    ...
    */
    ...
    /**
    * **[Line String](http://www.opengis.net/ont/sf#LineString)** (class)
    * 
    * 
    * A LineString is a Curve with linear interpolation between Points. Each consecutive pair of Points defines a Line segment.
    * 
    */
    LineString: prefixer('LineString'),

    /**
    * **[Linear Ring](http://www.opengis.net/ont/sf#LinearRing)** (class)
    * 
    * 
    * A LinearRing is a LineString that is both closed and simple.
    * 
    */
    LinearRing: prefixer('LinearRing'),

    /**
    * **[Multi Curve](http://www.opengis.net/ont/sf#MultiCurve)** (class)
    * 
    * 
    ...
    * 
    */
    MultiCurve: prefixer('MultiCurve'),

    /**
    * **[Multi Line String](http://www.opengis.net/ont/sf#MultiLineString)** (class)
    * 
    * 
    * A MultiLineString is a MultiCurve whose elements are LineStrings.
    * 
    */
    MultiLineString: prefixer('MultiLineString'),

    /**
    * **[Multi Point](http://www.opengis.net/ont/sf#MultiPoint)** (class)
    * 
    * 
    ...
    * 
    */
    MultiPoint: prefixer('MultiPoint'),

    /**
    * **[Multi Polygon](http://www.opengis.net/ont/sf#MultiPolygon)** (class)
    * 
    * 
    ...
    * 
    */
    MultiPolygon: prefixer('MultiPolygon'),

    /**
    * **[Multi Surface](http://www.opengis.net/ont/sf#MultiSurface)** (class)
    * 
    * 
    ...
    * 
    */
    MultiSurface: prefixer('MultiSurface'),

    /**
    * **[Point](http://www.opengis.net/ont/sf#Point)** (class)
    * 
    * 
    ...
    */
    ...
    /**
    * **[Polygon](http://www.opengis.net/ont/sf#Polygon)** (class)
    * 
    * 
    ...
    */
    ...
    /**
    * **[Surface](http://www.opengis.net/ont/sf#Surface)** (class)
    * 
    * 
    ...
    */
    ...
    /**
    * **[Polyhedral Surface](http://www.opengis.net/ont/sf#PolyhedralSurface)** (class)
    * 
    * 
    ...
    * 
    */
    PolyhedralSurface: prefixer('PolyhedralSurface'),

    /**
    * **[Triangulated Irregular Network](http://www.opengis.net/ont/sf#TIN)** (class)
    * 
    * 
